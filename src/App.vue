...
onMounted(() => {
  ...
  // 控制台输出
  const styleTitle = "background: linear-gradient(-225deg, rgba(251,0,255,0.729) 0, rgba(0,255,229,0.651) 100%) !important;cursor: pointer;border-radius: 4px;-webkit-border-radius: 5px; padding:5px;"
